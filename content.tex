...
\bibtex\ übernimmt die Verwaltung und Generierung des Literaturverzeichnisses, indem Referenzen im Text (z.B. mittels des \emph{Cite}-Befehls) mit verlinkten \fileType{bib}-Dateien abgeglichen werden. 
...
In Distribution wie \toolLink{http://www.tug.org/texlive/}{TeX Live} sind beide enthalten. 
...
Hilfreiche Dokumentation zu diesen findet man üblicherweise auf \infoLink{https://ctan.org/}{CTAN}. 
...
Um dieses Dokument kurz zu halten, konnten eine Vielzahl weiterer nützlicher Tipps und Werkzeuge nicht mit aufgenommen werden. An dieser Stelle sei erneut auf das umfangreiche \infoLink{https://sdqweb.ipd.kit.edu/wiki/Wissenschaftliches_Schreiben}{SDQ-Wiki} verwiesen. Ebenfalls hilfreich:

\smallskip
\begin{itemize}[label={\faLightbulbO}]
    \item Es gibt viele kostenlose aber mächtige Übersetzter-Tools wie \toolLink{https://www.deepl.com/translator}{DeepL} und \toolLink{https://www.linguee.de/}{Linguee}
